...
\section{Variational \& Weak Formulations}
\subfile{sections/3-formulations.tex}

\section{Basic Properties}
\subfile{sections/4-properties.tex}

\section{Well-posedness Theorems}
\subfile{sections/5-theorems.tex}

\section{Galerkine Method \& Properties}
\subfile{sections/6-galerkine.tex}

\section{Discretization}
\subfile{sections/7-discretization.tex}

\section{Filling in the Matrices}
\subfile{sections/8-matrices.tex}

\section{Considering Error}
\subfile{sections/9-error.tex}

\section{Numerical Results}
\subfile{sections/10-results.tex}
