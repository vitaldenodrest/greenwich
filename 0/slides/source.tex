...
\begin{frame}[fragile]
  ...
  \begin{block}{Continuity of a sesquilinear form}
    \vspace{-0.6cm}
      \begin{align*}
        \exists C_a \in \mathbb{R}, ~ \forall u,v \in V, ~ \left| a(u,v) \right| \le C_a \lvert \lvert u \rvert \rvert_V \lvert \lvert v \rvert \rvert_V
      \end{align*}
      \vspace{-0.6cm}
    \end{block}

  Given our sesquilinear form, proving its continuity over the Hilbert space $(H^1(0,1), \langle .,. \rangle_{L^2})$
  would require a constant $\lambda \in \mathbb{R}$
  for which:
  $$\forall u \in H^1(0,1), \lvert \lvert u' \rvert \rvert_{L^2} \le \lambda \lvert \lvert u \rvert \rvert_V$$
  This is not the case,
  and thus $a$ is unlikely to be continuous in this case.
  However, continuity is posible with other Hilbert spaces.
