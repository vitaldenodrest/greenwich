...
\end{equation}
However, it cannot be expressed as $k^h = f(k)$ because of the cosines of varying wavenumbers.
...
\begin{align*}
    ...
    &\chi = - \frac{1}{12} \frac{{\alpha_x^-}^3 + {\alpha_x^+}^3}{\alpha_x^- + \alpha_x^+} = - \frac{1}{12} \left({\alpha_x^{-}}^2 + {\alpha_x^{+}}^2 - \alpha_x^{-} \alpha_x^{+}\right) \\
    &\gamma_1 = \frac{1}{6} \frac{{\alpha_x^-}^3 + {\alpha_x^+}^3}{\alpha_x^- + \alpha_x^+} = - 2 \chi \\
