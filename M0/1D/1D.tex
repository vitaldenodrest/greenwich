...
an expression for $(k h_x)^2$ as a ratio of polynomials. It can be rewritten as:
\begin{align*}
...
\textit{Proof.}
The main route when computing this parameter is writing the GLS dispersion relation as in \ref{GalerkineDispRel} by
